...
export default {
    ...
    <section>
        <h1>This is the Kids TV page</h1>
    ...
    methods: {
        ...
        fetchtvs() {
            ...
            fetch('https://imdb-api.com/API/AdvancedSearch/k_xq3uunx4?title_type=tv_movie,tv_series,tv_episode,tv_special&release_date=1923-01-01,2023-01-01&certificates=us:PG-13,us:R,us:NC-17', requestOptions)
